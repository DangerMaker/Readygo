 ...
 */
public class HairListPresenter extends RtysListPresenter {

    public HairListPresenter(@NonNull RtysListContract.View view) {
        super(view);
    }

    @Override
    public void getData() {
        Subscription rxSubscription = RetrofitHelper.getImageApi().getHairUrlPage(Integer.toString(page))
