 ...
 */
public class WeimeiListPresenter extends RtysListPresenter {

    public WeimeiListPresenter(@NonNull RtysListContract.View view) {
        super(view);
    }

    @Override
    public void getData() {
        Subscription rxSubscription = RetrofitHelper.getImageApi().getWeimeiUrlPage(Integer.toString(page))
