 ...
 */
public class BeautyListPresenter extends RtysListPresenter {

    public BeautyListPresenter(@NonNull RtysListContract.View view) {
        super(view);
    }

    @Override
    public void getData() {
        Subscription rxSubscription = RetrofitHelper.getImageApi().getBeautyUrlPage(Integer.toString(page))
