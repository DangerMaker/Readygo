...
public class CameraActivity extends Activity {
    ...
    private static final int WRITE_EXTERNAL_STORAGE_REQUEST_CODE = 234;
    private static final int CAMERA_CODE = 345;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == WRITE_EXTERNAL_STORAGE_REQUEST_CODE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Log.e(LOG_TAG, "WRITE_EXTERNAL: success");
                doNext();
            } else {
                // Permission Denied
                Log.e(LOG_TAG, "WRITE_EXTERNAL: failure");
            }
        } else if (requestCode == CAMERA_CODE) {
            Log.e(LOG_TAG, "CAMERA: success");
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                doNextNext();
            } else {
                // Permission Denied
                Log.e(LOG_TAG, "CAMERA: failure");
            }
        }
    }
    ...
    private void doNext() {
        ...
        if (ContextCompat.checkSelfPermission(CameraActivity.this, Manifest.permission.CAMERA)
            ...
            doNextNext();
            Log.e(LOG_TAG, "write already");
        }

    }

    private void doNextNext() {
