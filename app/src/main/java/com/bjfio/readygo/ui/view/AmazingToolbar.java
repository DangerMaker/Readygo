package com.bjfio.readygo.ui.view;
...
import com.bjfio.readygo.ui.activitys.CameraActivity;
...
//        getContext().startService(new Intent(getContext(),TestService.class));
        ((BaseActivity)getContext()).setTheme(R.style.BlueGreyTheme);
    }
...
//        this.tabs = new TextView[]{this.left_tab, this.center_tab, this.right_tab};
    ...
    public void setViewPager(ViewPager paramViewPager,FragmentPagerAdapter paramContainerAdapter) {
